...
http://www.cs.ucr.edu/~eamonn/sigkdd_tarzan.pdf
"""
...
class Edge:
    __slots__ = ['fci', 'sni', 'lci', 'dni']

    def __init__(self, first_char_index, last_char_index, source_node_index,
                 destination_node_index):
        self.fci = first_char_index
        self.lci = last_char_index
        self.sni = source_node_index
        self.dni = destination_node_index

    def length(self):
        return self.lci - self.fci

    def __repr__(self):
        return 'Edge(%d, %d, %d, %d)' % (self.sni, self.dni, self.fci, self.lci)


class Suffix(object):
    __slots__ = ['fci', 'sni', 'lci']
...
class SuffixTree(object):
    ...
    def __repr__(self):
        ...
        for edge in values:
            ...
            s += "\t%s \t%s \t%s \t%s \t%s \t" % (edge.source_node_index
                                                  ...
                                                  , self.nodes[
                                                      edge.dest_node_index].suffix_node
    ...
    def _add_prefix(self, last_char_index):
        ...
        while True:
            ...
            if self.active.explicit():
                ...
                e = self.edges[self.active.source_node_index, self.string[
                    self.active.first_char_index]]
            ...
            if self.active.source_node_index == 0:
                ...
                self.active.source_node_index = self.nodes[
                    self.active.source_node_index].suffix_node
    ...
    def _insert_edge(self, edge):
        self.edges[
            (edge.source_node_index, self.string[edge.first_char_index])] = edge
    ...
    def _split_edge(self, edge, suffix):
        ...
        self._insert_edge(e)
        self.nodes[
            e.dest_node_index].suffix_node = suffix.source_node_index  ### need to add node for each edge
    ...
    def find_substring(self, substring):
        ...
        while i < len(substring):
            ...
            if substring[i:i + ln] != self.string[
                                      edge.first_char_index:edge.first_char_index + ln]:
                return -1
            i += edge.length + 1
